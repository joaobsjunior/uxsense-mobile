...
function($ionicLoadingConfig, $ionicBody, $ionicTemplateLoader, $ionicBackdrop, $timeout, $q, $log, $compile, $ionicPlatform, $rootScope, IONIC_BACK_PRIORITY) {
  ...
  // Patched for AngularJS >= 1.7: $timeout.cancel() throws "badprom" when given a
  // promise that was not created by $timeout(), so do not seed this with $q.when().
  var loadingShowDelay;
